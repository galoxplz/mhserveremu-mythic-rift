...
namespace MHServerEmu.Games.Network
{
    ...
    public class PlayerConnection : NetClient
    {
        ...
        private bool TryInterceptMythicRiftBeaconPowerActivation(Avatar avatar, PrototypeId powerProtoRef, bool hasItemSourceId, ulong itemSourceId)
        {
            ...
            Logger.Debug($"[MythicRiftLauncher] Beacon power activation was not intercepted playerDbId=0x{Player.DatabaseUniqueId:X} power={powerProtoRef.GetNameFormatted()} hasItemSourceId={hasItemSourceId} itemSourceId={itemSourceId} sourceItem={sourceItemSummary} trackedCharges={trackedCharges}");
            return false;
        }
